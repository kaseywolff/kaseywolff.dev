  ...
  return(
    <div className='page'>
      ...
      <div className='container about'>
        ...
        <p>
            I'm a Software Engineer who loves tackling and solving complex problems. I am someone who approaches new things with a sense of curiosity, wonder, and a genuine desire to understand how things work.
          </p>
          <br/>
          <p>
            In every line of code I write, I strive for craftsmanship, valuing the art and science of software engineering. I believe in the beauty of simplicity, the power of efficiency, and the elegance of functionality. My approach to software development goes beyond merely solving problems; it involves creating solutions that are not only effective but also a enjoyable to work with.
          </p>
          <br/>
          <p>
            Whether I'm working with React, employing test-driven development, or delving into the intricacies of full-stack development, I bring a commitment to craftsmanship. It's not just about writing code; it's about creating a foundation that cultivates comprehension, encourages collaboration, and paves the way for long-term success.
          </p>
          <br/>
          <p>
            In navigating the dynamic landscape of software engineering, I embrace the delicate balance between exploring innovative solutions and embracing proven approaches. This blend of creativity and reliability ensures that my work is not only innovative but also grounded in the stability of established methodologies.
          </p>
          <br/>
          <p>
            My contributions to Recoilize, a <a href='https://chrome.google.com/webstore/detail/recoilize/jhfmmdhbinleghabnblahfjfalfgidik' target='_blank' className='hyperlink'>Chrome Extension</a> and <a href='https://www.npmjs.com/package/recoilize' target='_blank' className='hyperlink'>npm package</a>, reflect this dedication. As a core contributor, I am passionate about enhancing developers' experiences by visualizing state management, debugging efficiently, and ultimately elevating the quality of applications built with <a href='https://recoiljs.org/' target='_blank' className='hyperlink'>Recoil.js</a>.
          </p>
          <br/>
          <p>
