...
function About() {
  ...
  const [funFactsLoaded, setFunFactsLoaded] = useState(false);
  ...
  return (
    <div className='page'>
      ...
      {!helloLoaded && <Loading />}
      <div className='container hello' style={{ display: helloLoaded ? 'flex' : 'none' }}>
      ...
      {!aboutLoaded && <Loading />}
      <div className='container about' style={{ display: aboutLoaded ? 'flex' : 'none' }}>
        <h2>about</h2>
      ...
      {!funFactsLoaded && <Loading />}
      <div className='container fun-facts' style={{ display: funFactsLoaded ? 'flex' : 'none' }}>
        <h2>fun facts</h2>
